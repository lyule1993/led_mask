...
class FlutterBlue {
  ...
  static FlutterBlue _instance = new FlutterBlue();
  static FlutterBlue get instance => _instance;
  FlutterBlue getNewInstance(){
    _instance =  FlutterBlue();
    return _instance;
  }
  ...
  /// Returns a stream that is a list of [ScanResult] results while a scan is in train.
  ///
  ...
  /// results of a scan in real time while the scan is in train.
  ...
  /// If scanning is already in train, this will throw an [Exception].
  Stream<ScanResult> scan({
    ...
    if (_isScanning.value == true) {
      throw Exception('Another scan is already in train.');
    }
  ...
  ///
  /// To observe the results while the scan is in train, listen to the [scanResults] stream,
